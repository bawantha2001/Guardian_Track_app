...
public class MainActivity extends AppCompatActivity{
    ...
    public void showMessages(){
        ...
        if(count>0){
            ...
            if(count==1) {
                nolocationTriggers.setText("Guardian Track is ready!\n\nNow,Send the trigger word:\n"+message+"\nto this device through WhatsApp/Normal message to get this device location!");
                nolocationTriggers.setCompoundDrawables(null,null,null,null);
            }
